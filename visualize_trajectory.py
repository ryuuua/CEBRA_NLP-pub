...
@hydra.main(config_path="conf", config_name="trajectory_viz", version_base="1.2")
def main(cfg: DictConfig) -> None:
    from cebra_nlp_public.stages.trajectory_viz import run as run_trajectory_viz
    ...
    run_trajectory_viz(typed_cfg, output_dir, is_main_process=is_main)
    cleanup_distributed()
