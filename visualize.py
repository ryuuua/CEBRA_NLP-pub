...
@hydra.main(config_path="conf", config_name="viz", version_base="1.2")
def main(cfg: DictConfig) -> None:
    from cebra_nlp_public.stages.viz import run as run_viz
    ...
    run_viz(typed_cfg, output_dir, is_main_process=is_main)
    cleanup_distributed()
